...
LSystem.prototype = {
   ...
   * Extra Symbols:
   *
   * 'L' - draw a simple leaf, only drawn when at terminal positions
   *
   ...
   */
  interpret: function(derivation, parameters) {
